package page.controller.center.best;
...
@Controller
public class CenterBestVolunteerController {
	
	@Autowired BestVolunteerService bestVolunteerService;

	private static final Logger logger =LoggerFactory.getLogger(CenterBestVolunteerController.class); 

	@RequestMapping(value = "/center/best/bestlist", method = RequestMethod.GET)
...
//		logger.info("성공");
	...
	@RequestMapping(value = "/center/best/bestview", method = RequestMethod.GET)
