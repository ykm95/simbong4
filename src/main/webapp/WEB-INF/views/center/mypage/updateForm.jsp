...
<label for ="mphone">담당자번호</label>
<input type="tel" name="mphone" id="mphone" value="${center.mphone }"/>
<div class="check_front" id="phone_check"> 
</div><br>

<label for="memail">담당자이메일</label>
<input type="text" name="memail" value="${center.memail }">
<br><br>

<label>담당자명</label>
<input type="text" name="mgr" value="${center.mgr }">
<br><br>

<label>주소</label>
<br>
<input type="text" id="address1" name="address1" value="${center.address1 }"/>

<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"/>
<br>

<input type="text" id="address2" name="address2" value="${center.address2 }" />
<input type="text" id="address3" name="address3" value="${center.address3 }" />
<br><br>
