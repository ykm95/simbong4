		...
		<c:forEach items="${list }" var="i">
			...
			style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc">
				<div class="row">
					...
					<div class="col-3"><small>${i.aname }</small></div>
				</div>
				<div class="row">
