			...
			<table
				...
				<tbody>
					<tr>
						...
						</select> <select name="t_department" id="t_department" title="활동영역 세부"
					...
					<tr>
						...
						</select> <select name="t_area" id="t_area" title="시군구"
							style="width: 180px; height: 28px;" disabled="disabled">
						...
						<td style="line-height: 200%"><input name="t_type"
							...
							for="t_typeA">전체</label> &nbsp; <input name="t_type"
							title="개인" id="t_typeI" type="radio" value="1">&nbsp;<label
							for="t_typeI">개인</label> &nbsp; <input name="t_type"
							title="단체" id="t_typeG" type="radio" value="2">&nbsp;<label
					...
					<tr>
						<th>내용</th>
						<td><textarea rows="500px" cols="400px" name="t_content"
