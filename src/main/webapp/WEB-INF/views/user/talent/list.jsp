...
<div class="container">
	...
	<form action="/user/talent/list" method="get" id="searchForm" style="margin-top:40px;">
		...
		<div class="row">
			<div class="col">
		<select id="srcDepart" name="srcDepart" title="활동영역" class="form-control">
			...
			<div class="col">
		<select class="form-control" name="departmentno" id="departmentno" title="활동영역 세부"class="form-control"disabled="disabled">
		<option value="">선택</option>
		</select>
			</div></div>
		<br>
		...
		<select class="form-control" title="시도" name="srcArea" id="srcArea" >
			...
			<div class="col">
		<select class="form-control" name="areano" id="areano" title="시군구" disabled="disabled" >
			<option value="">선택</option>
		</select>
			</div>
		</div><br>
	...
	<div>${count } 건의 검색결과가 있습니다.</div><hr style="margin-bottom:0px;border-bottom:1px solid black;border-top:0;">
