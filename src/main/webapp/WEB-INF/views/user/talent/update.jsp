								...
								.change(
										function() {
											if ($(this).val() == '1') {
												$("#department")
														.html(
																"<option value=''>선택</option><option value='1'> 또래상담</option><option value='2'> 대학생 - 중·고생 멘토링</option><option value='3'> 검정고시 대비반 멘토링(학교 밖 청소년 등)</option><option value='4'> 수학</option><option value='5'> 영어</option><option value='6'> 사회, 과학 등 기타과목</option><option value='7'> 요리</option><option value='8'> 진로</option><option value='9'> 언어</option><option value='10'> 컴퓨터</option><option value='11'> 경제,금융</option>");

											} else if ($(this).val() == '2') {
												$("#department")
														.html(
																"<option value=''>선택</option><option value='12'> 영상 편집</option><option value='13'> 언어지원</option><option value='14'> 의료지원</option><option value='15'> 기사작성</option><option value='16'> 디자인</option><option value='17'> 미용</option><option value='18'> 노래</option><option value='19'> 댄스</option><option value='20'> 스포츠(e스포츠)</option><option value='21'> 미술</option><option value='22'> 악기연주</option>");
											} else if ($(this).val() == '3') {
												$("#department")
														.html(
																"<option value=''>선택</option><option value='23'> 체험관</option><option value='24'> 과학관</option><option value='25'> 미술관</option><option value='26'> 박물관</option><option value='27'> 기타 지역사회 시설</option>");
											} else if ($(this).val() == '') {
												$("#department")
														.html(
			...
			<table
				...
				<tbody>
					<tr>
						...
						</select> <select name="department" id="department" title="활동영역 세부"
					...
					<tr>
						...
						</select> <select name="talent_area" id="talent_area" title="시군구"
							style="width: 180px; height: 28px;" disabled="disabled">
					...
					<tr>
						...
						<td><label><input name="talent_cycle"
								id="talent_cycleAll" type="checkbox" value="all" title="전체">&nbsp;전체</label>&nbsp;&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="월" title="월">&nbsp;월</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="화" title="화">&nbsp;화</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="수" title="수">&nbsp;수</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="목" title="목">&nbsp;목</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="금" title="금">&nbsp;금</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="토" title="토">&nbsp;토</label>&nbsp;&nbsp;<label><input
								name="talent_cycle" type="checkbox" value="일" title="일">&nbsp;일</label>&nbsp;&nbsp;</td>
					</tr>
					...
					<tr>
						<th>내용</th>
						<td><textarea rows="500px" cols="400px" name="vol_content"
