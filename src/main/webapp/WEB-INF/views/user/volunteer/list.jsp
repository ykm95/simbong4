...
<script type="text/javascript">
      $(document).ready(function() {
    	//활동영역
    		...
    		$("#department").prop("value","${param.department}");	//활동영역 세부
...
<div class="container">
	...
	<form action="/user/volunteer/list" method="get" id="searchForm" style="margin-top:40px;">
		...
		<div class="row">
			<div class="col">
		<input name="v_sterm" title="시작일" id="v_sterm"
		type="date" value="" class="form-control"></div>
		~ 
		<div class="col">
		<input
		name="v_eterm" title="종료일" id="v_eterm"
		...
		<div class="row">
			<div class="col">
		<input name="v_stime" title="시작시간" id="v_stime" class="form-control" type="time" value=""></div> 
		~
		<div class="col"> 
		<input name="v_etime" title="종료시간" id="v_etime" class="form-control" type="time" value=""></div>
				</div><br>	
		...
		<select class="form-control" title="시도" name="srcArea" id="srcArea" >
			...
			<div class="col">
		<select class="form-control" name="v_area" id="v_area" title="시군구" disabled="disabled" >
			<option value="">선택</option>
		</select>
			</div>
		</div><br>
		...
		<div>
		상태 &nbsp; &nbsp; &nbsp; &nbsp;
		<input name="v_process" title="전체" id="processAll" type="radio" value="0" checked="checked">&nbsp;
		<label for="processAll">전체</label> &nbsp; 
		
		<input name="v_process" title="모집중" id="process1" type="radio" value="1">&nbsp;
		<label for="process1">모집중</label>&nbsp; 
		
		<input name="v_process" title="모집완료" id="process2" type="radio" value="2">&nbsp;
	...
	<div>${vcount } 건의 검색결과가 있습니다.</div><hr style="margin-bottom:0px;border-bottom:1px solid black;border-top:0;">
	...
	<tr>
    	...
    	<td colspan="2" style="border-bottom:0;border-top:0;"><a href="/user/volunteer/view?volunteerno=${list.volunteerno }" style="font-size: 35px;">${list.v_title }</a></td>
	...
	<tr>    
    	...
    	<td style="border-bottom:1px solid #ccc;border-top:0;"><span style="color:#0371c1">활동기간:</span> ${list.v_sterm } ~ ${list.v_eterm }</td>
    	<td style="border-bottom:1px solid #ccc;border-top:0;"><span style="color:#0371c1">활동시간:</span> ${list.v_stime } ~ ${list.v_etime }</td>
