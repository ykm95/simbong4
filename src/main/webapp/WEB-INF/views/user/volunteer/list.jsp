...
<script type="text/javascript">
      $(document).ready(function() {
    	//활동영역
    		...
    		$("#vol_area").prop("value","${param.vol_area}");	//활동지역 세부
    		
    		//활동일자
    		$("#vol_sterm").prop("value","${param.vol_sterm}");
    		$("#vol_eterm").prop("value","${param.vol_eterm}");
    		
    		//활동일자
    		$("#stime").prop("value","${param.stime}");
    		$("#etime").prop("value","${param.etime}");
    		...
    		//상태
    		$("input[type='radio'][name='vol_process'][value='${param.vol_process}']").prop("checked", true);
			});
</script>
